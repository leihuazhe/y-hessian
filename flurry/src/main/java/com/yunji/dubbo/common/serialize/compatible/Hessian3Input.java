...
import com.yunji.flurry.jsonserializer.JsonCallback;
...
/**
 * @author Denim.leihz 2019-10-23 4:43 PM
 */
public class Hessian3Input extends Hessian3InputBase {
    ...
    public Hessian3Input(InputStream is) {
        super(is);
    }
