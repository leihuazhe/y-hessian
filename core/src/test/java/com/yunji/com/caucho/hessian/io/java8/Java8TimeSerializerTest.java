...
package com.yunji.com.caucho.hessian.io.java8;
...
public class Java8TimeSerializerTest {
    ...
    private static com.yunji.com.caucho.hessian.io.SerializerFactory factory;
    ...
    private void testJava8Time(Object expected) throws IOException {
        ...
        com.yunji.com.caucho.hessian.io.Hessian2Output output = new Hessian2Output(os);
        output.setSerializerFactory(factory);
        output.writeObject(expected);
        output.flush();

        ByteArrayInputStream is = new ByteArrayInputStream(os.toByteArray());
        com.yunji.com.caucho.hessian.io.Hessian2Input input = new Hessian2Input(is);
